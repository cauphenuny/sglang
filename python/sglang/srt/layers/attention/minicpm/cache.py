...
def create_req_to_token_pool(
    *,
    ...
    sparse = (
        config.has_minicpm_sparse_attention
        and not runner.server_args.minicpm_force_dense
    )
    ...
    hybrid = dict(
        **common,
        cache_params=cache_params,
        mamba_size=runner.server_args.max_mamba_cache_size,
        mamba_spec_state_size=size,
        enable_mamba_extra_buffer=runner.server_args.enable_mamba_extra_buffer(),
        speculative_num_draft_tokens=runner.server_args.speculative_num_draft_tokens,
    )
    if sparse:
    ...
    return HybridReqToTokenPool(
        **hybrid,
        ...
        enable_overlap_schedule=not runner.server_args.disable_overlap_schedule,
